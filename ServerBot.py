...
async def random_num(ctx, min = commands.parameter(default=int(), description="- Minimum value"), max = commands.parameter(default=int(), description="- Maximum value"), steps = commands.parameter(default=int(), description="- the change between numbers")):
    import random
    await ctx.defer()
    try:
        random_num = random.randrange(min, max, steps)
