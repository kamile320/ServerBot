...
Play music from YouTube URL's and your local files, talk with AI (gemini based), use administration/moderation commands and the most important - operate with files, directories, and run shellscripts on your hosting computer.*  
